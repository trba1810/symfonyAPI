...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: UserProjectHours::class, orphanRemoval: true)]
    ...
    public function removeUserProjectHours(UserProjectHours $userProjectHours): static
    {
        if ($this->userProjectHours->removeElement($userProjectHours)) {
            ...
            if ($userProjectHours->getUser() === $this) {
                $userProjectHours->setUser(null);
            }
        }
        return $this;
    }
